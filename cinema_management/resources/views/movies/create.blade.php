            ...
            <div class="card-body items-center text-center">
                <form action="{{ route('movie.store') }}" method="post">
                    ...
                    <input type="text" placeholder="Type here"
                        class="input input-bordered input-primary w-full max-w-xs mt-3" name="title"/><br><br>
                    <label for="" class='text-lg'>Genre</label>
                    <input type="text" placeholder="Type here"
                        class="mt-3 input input-bordered input-primary w-full max-w-xs" name="genre"/><br><br>
                    <label for="" class='text-lg'>Director</label>
                    <input type="text" placeholder="Type here"
                        class="mt-3 input input-bordered input-primary w-full max-w-xs" name="director"/><br><br>
                    <label for="" class='text-lg'>Description</label>
                    <input type="text" placeholder="Type here"
                        class="mt-3 input input-bordered input-primary w-full max-w-xs" name="des"/><br><br>
