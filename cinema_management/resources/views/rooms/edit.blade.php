        ...
        <div class="card-body items-center text-center">
            <form action="{{ route('room.update',$room->id) }}" method="post">
                ...
                <input type="text" placeholder="Type here"
                    class="input input-bordered input-primary w-full max-w-xs mt-3" name="no_room" value="{{ $room->no_room }}"/><br><br>
                <label for="" class='text-lg'>Number of Chairs</label>
                <input type="number" placeholder="Type here"
                    class="mt-3 input input-bordered input-primary w-full max-w-xs" name="no_chairs" value="{{ $room->no_chairs }}"/><br><br>
